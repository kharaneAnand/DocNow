            ...
            item.docId && (
              <div key={index} className='grid grid-col-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b'>
                ...
                <div className='flex flex-col gap-2 justify-end'>
                 {!item.cancelled && !item.isCompleted && <button className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-green-500 hover:text-white transition-all duration-300'>Pay Online</button> } 
