...
const Contacts = () => {
  return (
    <div className="px-6 md:px-20 lg:px-40 bg-gradient-to-b from-white to-gray-100  mt-5 mb-16 py-16">
      {/* Header */}
      ...
      {/* Main Content */}
      <div className="flex flex-col md:flex-row items-center gap-12 bg-white p-10 rounded-3xl shadow-2xl transition-all duration-300 hover:shadow-indigo-300">
        {/* Image */}
        <img
          className="w-full md:max-w-sm object-cover rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300 ease-in-out"
          src={assets.contact_image}
          alt="Contact"
        />

        {/* Contact Info */}
        <div className="flex flex-col gap-6 text-gray-700 text-[17px]">
          {/* Office Info */}
          <div>
